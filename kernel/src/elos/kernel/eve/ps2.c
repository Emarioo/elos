...
//         _default_keymap.scancode_to_keycode[(((scancode >> 8) == 0xE0) ? 256 : 0) + (scancode & 0xFF)].keycode = keycode; 
//         _default_keymap.scancode_to_keycode[(((scancode >> 8) == 0xE0) ? 256 : 0) + (scancode & 0xFF)].scancode = scancode;
//     }
