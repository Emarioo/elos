/*
    ...
    This version is slower because it always does 4 splits.
    Since most splits halve the rectangles this is very innefficient.
...
#define ZERO_RECT create_rect(r->x, r->y, r->w, r->h)
        ...
        // {
            ...
            if(r0.w>0&&r0.h>0){
                // i32 index = 
                surface_add(surface, r0);
                // POST_SURFACE_ADD
            }
            if(r1.w>0&&r1.h>0){
                // i32 index = 
                surface_add(surface, r1);
                // POST_SURFACE_ADD
            }
            if(r2.w>0&&r2.h>0){
                // i32 index = 
                surface_add(surface, r2);
                // POST_SURFACE_ADD
            }
            if(r3.w>0&&r3.h>0){
                // i32 index = 
                surface_add(surface, r3);
                // POST_SURFACE_ADD
            }
            // break;
        // }
